...
class MinecraftServerLauncher(tk.Tk):
    def __init__(self):
        ...
        self.memory_xms = tk.StringVar(value="1024")  # Initial RAM in MB
        self.memory_xmx = tk.StringVar(value="2048")  # Max RAM in MB
    ...
    def create_widgets(self):
        ...
        # Config Editor Button (initially hidden)
        self.edit_config_btn = ttk.Button(self, text="📝 Edit Config", style="RoundedButton.TButton", command=self.open_config_editor)
        self.edit_config_btn.pack(pady=5)
        self.edit_config_btn.pack_forget()  # hide by default
    ...
    def launch_server(self):
        ...
        self.edit_config_btn.pack()  # Show config button after launching
    ...
    def open_config_editor(self):
        subprocess.Popen(["python", "ConfigProfile.py"])  # Or "ConfigEditor.exe" if compiled
